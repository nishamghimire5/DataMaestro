    ...
    <div className="space-y-4">
      ...
      >
        ...
        <TabsContent value="correct" className="mt-2">
          <Label htmlFor="correctText" className="text-base font-medium">Enter Text to Correct:</Label>
          <Textarea
            id="correctText"
            value={inputText}
      ...
      {result && (
        <div className="mt-6 space-y-4">
          ...
          {!result.threadParts && (
            <div className="p-4 border rounded-md bg-muted/50">              <div className="flex justify-between items-center mb-2">
                ...
                <p className="text-sm text-muted-foreground">{mode === 'correct' ? 'Corrected Text:' : 'Generated Text:'}</p>
